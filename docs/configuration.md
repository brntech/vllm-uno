...
the JIT monitor, and CUDA-graph capture sizes
`[1,2,4,8,16,32,64,128,144,256]`. The final `256` captures the bounded
32-request × K=8 draft-row shape rather than falling back to eager drafting.
